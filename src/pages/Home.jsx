        ...
        <div style={{ ...C.container, maxWidth: '680px', textAlign: 'center' }}>
          <FadeUp>
            ...
            {subscribed ? (
              ...
              <form onSubmit={e => { e.preventDefault(); if (!email) return; try { window.OliveCollector && window.OliveCollector.submit('newsletter', { email: email, source: 'home' }); } catch (err) {} setSubscribed(true); }} style={{ display: 'flex', gap: 0, maxWidth: '420px', margin: '0 auto' }}>
