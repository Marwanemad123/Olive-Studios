          ...
          <FadeUp delay={0.15}>
            <div style={PAGE.card}>
              ...
              {sent ? (
                ...
                <form onSubmit={e => { e.preventDefault(); try { window.OliveCollector && window.OliveCollector.submit('corporate', { name: form.name, company: form.company, email: form.email, phone: form.phone, projectType: form.projectType, message: form.message }); } catch (err) {} setSent(true); }} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
