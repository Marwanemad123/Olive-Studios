  ...
  starOfMonth: [
    {
      ...
      titleAr: 'المصوّر رقم ١',
      subtitle: 'Feature pending.',
      subtitleAr: 'المقال قيد الإعداد.',
      cover: window.PLACEHOLDER_IMAGE,
      coverFit: 'cover',
      excerpt: "Feature pending. Add the interview here — who the photographer is, what they were working on when you met, and what a collector should understand about the work before buying a print.",
      excerptAr: 'المقال قيد الإعداد. أضف هنا الحوار — من هو المصوّر، وعلى ماذا كان يعمل حين التقيتموه، وما الذي ينبغي للمقتني معرفته عن العمل قبل الشراء.',
      readMins: 6,
      tag: 'Featured Artist',
      tagAr: 'الفنانة المختارة',
      // Pieces by this artist to feature inline
      relatedArtworkIds: ['p1-work-1', 'p1-work-2'],
    },
  ],
  behindScenes: [
    {
      ...
      titleAr: 'بناء إصدار',
      subtitle: 'Production story pending.',
      subtitleAr: 'قصة الإنتاج قيد الإعداد.',
      cover: window.PLACEHOLDER_IMAGE,
      coverFit: 'cover',
      excerpt: "Production story pending. Walk the reader through how one edition came together — the idea, the build, the shoot, and the print.",
      excerptAr: 'قصة الإنتاج قيد الإعداد. اصطحب القارئ عبر مراحل تكوّن أحد الإصدارات — الفكرة، والتحضير، والتصوير، والطباعة.',
      readMins: 8,
      tag: 'Production',
      tagAr: 'الإنتاج',
    },
    ...
    },
    {
      ...
      cover: (window.__resources&&window.__resources.artwork3)||'src/assets/artwork-3.jpg',
      coverFit: 'cover',
...
const STAR_BODY_EN = [
  'Profile pending. Write the photographer\'s story here — where they came up, what they photograph, and what changed for them recently.',
  'Pull quote pending. — Photographer #1, in the studio.',
  'The editions below are fixed and signed.',
];
const STAR_BODY_AR = [
  'الملف قيد الإعداد. اكتب هنا قصة المصوّر — أين نشأ، وماذا يصوّر، وما الذي تغيّر لديه مؤخراً.',
  'الاقتباس قيد الإعداد. — المصوّر رقم ١، في الاستوديو.',
  'الإصدارات أدناه ثابتة وموقّعة.',
];
