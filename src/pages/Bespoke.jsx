...
function BespokePage({ navigate, tweaks = {}, lang = 'EN' }) {
  ...
  const handleSubmit = e => {
    e.preventDefault();
    try { window.OliveCollector && window.OliveCollector.submit('bespoke', { name: form.name, email: form.email, phone: form.phone, projectType: form.projectType, budget: form.budget, timeline: form.timeline, description: form.description }); } catch (err) {}
